...
void MdReader::ParseMdTickRecord(duckdb_result& result, std::list<mdb::DepthMarketData*>& records)
{
	while (true)
	{
		...
		for (idx_t row = 0LL; row < rowCount; ++row)
		{
			...
			if (duckdb_validity_row_is_valid(validityColumn11, row)) record->CurrVolume = (int64_t)dataColumn11[row];
			if (duckdb_validity_row_is_valid(validityColumn12, row)) record->Volume = (int64_t)dataColumn12[row];
			...
			if (duckdb_validity_row_is_valid(validityColumn25, row)) record->AskVolume1 = (int64_t)dataColumn25[row];
			if (duckdb_validity_row_is_valid(validityColumn26, row)) record->AskVolume2 = (int64_t)dataColumn26[row];
			if (duckdb_validity_row_is_valid(validityColumn27, row)) record->AskVolume3 = (int64_t)dataColumn27[row];
			if (duckdb_validity_row_is_valid(validityColumn28, row)) record->AskVolume4 = (int64_t)dataColumn28[row];
			if (duckdb_validity_row_is_valid(validityColumn29, row)) record->AskVolume5 = (int64_t)dataColumn29[row];
			if (duckdb_validity_row_is_valid(validityColumn30, row)) record->AskVolume6 = (int64_t)dataColumn30[row];
			if (duckdb_validity_row_is_valid(validityColumn31, row)) record->AskVolume7 = (int64_t)dataColumn31[row];
			if (duckdb_validity_row_is_valid(validityColumn32, row)) record->AskVolume8 = (int64_t)dataColumn32[row];
			if (duckdb_validity_row_is_valid(validityColumn33, row)) record->AskVolume9 = (int64_t)dataColumn33[row];
			if (duckdb_validity_row_is_valid(validityColumn34, row)) record->AskVolume10 = (int64_t)dataColumn34[row];
			...
			if (duckdb_validity_row_is_valid(validityColumn45, row)) record->BidVolume1 = (int64_t)dataColumn45[row];
			if (duckdb_validity_row_is_valid(validityColumn46, row)) record->BidVolume2 = (int64_t)dataColumn46[row];
			if (duckdb_validity_row_is_valid(validityColumn47, row)) record->BidVolume3 = (int64_t)dataColumn47[row];
			if (duckdb_validity_row_is_valid(validityColumn48, row)) record->BidVolume4 = (int64_t)dataColumn48[row];
			if (duckdb_validity_row_is_valid(validityColumn49, row)) record->BidVolume5 = (int64_t)dataColumn49[row];
			if (duckdb_validity_row_is_valid(validityColumn50, row)) record->BidVolume6 = (int64_t)dataColumn50[row];
			if (duckdb_validity_row_is_valid(validityColumn51, row)) record->BidVolume7 = (int64_t)dataColumn51[row];
			if (duckdb_validity_row_is_valid(validityColumn52, row)) record->BidVolume8 = (int64_t)dataColumn52[row];
			if (duckdb_validity_row_is_valid(validityColumn53, row)) record->BidVolume9 = (int64_t)dataColumn53[row];
			if (duckdb_validity_row_is_valid(validityColumn54, row)) record->BidVolume10 = (int64_t)dataColumn54[row];
			records.push_back(record);
		}
	}
}
