...
namespace mdb
{
	...
	const char* Product::GetString() const
	{
		sprintf(t_MdbDataStringBuffer, "%s,%s,%s,%d,%d,%f,%lld,%lld,%lld,%lld,%s",
			ExchangeID, ProductID, ProductName, (int)SecurityType, VolumeMultiple, PriceTick, MaxMarketOrderVolume, MinMarketOrderVolume, MaxLimitOrderVolume, MinLimitOrderVolume, SessionName);
		return t_MdbDataStringBuffer;
	}
	...
	{
		sprintf(t_MdbDataStringBuffer, "Product:ExchangeID:[%s], ProductID:[%s], ProductName:[%s], SecurityType:[%d], VolumeMultiple:[%d], PriceTick:[%f], MaxMarketOrderVolume:[%lld], MinMarketOrderVolume:[%lld], MaxLimitOrderVolume:[%lld], MinLimitOrderVolume:[%lld], SessionName:[%s]",
			ExchangeID, ProductID, ProductName, (int)SecurityType, VolumeMultiple, PriceTick, MaxMarketOrderVolume, MinMarketOrderVolume, MaxLimitOrderVolume, MinLimitOrderVolume, SessionName);
		return t_MdbDataStringBuffer;
	}
	...
	{
		sprintf(t_MdbDataStringBuffer, "%s,%s,%s,%s,%s,%s,%d,%d,%d,%f,%lld,%lld,%lld,%lld,%s",
			TradingDay, ExchangeID, InstrumentID, ExchangeInstID, InstrumentName, ProductID, (int)SecurityType, (int)SecurityDetailType, VolumeMultiple, PriceTick, MaxMarketOrderVolume, MinMarketOrderVolume, MaxLimitOrderVolume, MinLimitOrderVolume, SessionName);
		return t_MdbDataStringBuffer;
	}
	int Instrument::GetSqlString(char* buff) const
	{
		return sprintf(buff, "\n('%s','%s','%s','%s','%s','%s','%d','%d','%d','%f','%lld','%lld','%lld','%lld','%s'),",
			TradingDay, ExchangeID, InstrumentID, ExchangeInstID, InstrumentName, ProductID, (int)SecurityType, (int)SecurityDetailType, VolumeMultiple, PriceTick, MaxMarketOrderVolume, MinMarketOrderVolume, MaxLimitOrderVolume, MinLimitOrderVolume, SessionName);
	}
	const char* Instrument::GetDebugString() const
	{
		sprintf(t_MdbDataStringBuffer, "Instrument:TradingDay:[%s], ExchangeID:[%s], InstrumentID:[%s], ExchangeInstID:[%s], InstrumentName:[%s], ProductID:[%s], SecurityType:[%d], SecurityDetailType:[%d], VolumeMultiple:[%d], PriceTick:[%f], MaxMarketOrderVolume:[%lld], MinMarketOrderVolume:[%lld], MaxLimitOrderVolume:[%lld], MinLimitOrderVolume:[%lld], SessionName:[%s]",
			TradingDay, ExchangeID, InstrumentID, ExchangeInstID, InstrumentName, ProductID, (int)SecurityType, (int)SecurityDetailType, VolumeMultiple, PriceTick, MaxMarketOrderVolume, MinMarketOrderVolume, MaxLimitOrderVolume, MinLimitOrderVolume, SessionName);
		return t_MdbDataStringBuffer;
	}
	...
	{
		sprintf(t_MdbDataStringBuffer, "%s,%s,%d,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f",
			TradingDay, AccountID, (int)AccountType, Asset, PreAsset, CashAsset, PreCashAsset, Available, CashIn, CashOut, Margin, Commission, StampTax, TransferFee, FrozenCash, FrozenMargin, FrozenCommission, FrozenStampTax, FrozenTransferFee, MarketValue, TotalProfit, TodayProfit, Deposit, Withdraw);
		return t_MdbDataStringBuffer;
	}
	int Capital::GetSqlString(char* buff) const
	{
		return sprintf(buff, "\n('%s','%s','%d','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f'),",
			TradingDay, AccountID, (int)AccountType, Asset, PreAsset, CashAsset, PreCashAsset, Available, CashIn, CashOut, Margin, Commission, StampTax, TransferFee, FrozenCash, FrozenMargin, FrozenCommission, FrozenStampTax, FrozenTransferFee, MarketValue, TotalProfit, TodayProfit, Deposit, Withdraw);
	}
	const char* Capital::GetDebugString() const
	{
		sprintf(t_MdbDataStringBuffer, "Capital:TradingDay:[%s], AccountID:[%s], AccountType:[%d], Asset:[%f], PreAsset:[%f], CashAsset:[%f], PreCashAsset:[%f], Available:[%f], CashIn:[%f], CashOut:[%f], Margin:[%f], Commission:[%f], StampTax:[%f], TransferFee:[%f], FrozenCash:[%f], FrozenMargin:[%f], FrozenCommission:[%f], FrozenStampTax:[%f], FrozenTransferFee:[%f], MarketValue:[%f], TotalProfit:[%f], TodayProfit:[%f], Deposit:[%f], Withdraw:[%f]",
			TradingDay, AccountID, (int)AccountType, Asset, PreAsset, CashAsset, PreCashAsset, Available, CashIn, CashOut, Margin, Commission, StampTax, TransferFee, FrozenCash, FrozenMargin, FrozenCommission, FrozenStampTax, FrozenTransferFee, MarketValue, TotalProfit, TodayProfit, Deposit, Withdraw);
		return t_MdbDataStringBuffer;
	}
	...
	{
		sprintf(t_MdbDataStringBuffer, "%s,%s,%d,%s,%s,%d,%d,%lld,%lld,%lld,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%d,%f,%f,%f,%f,%f,%f",
			TradingDay, AccountID, (int)AccountType, ExchangeID, InstrumentID, (int)SecurityType, (int)PosiDirection, TotalPosition, PositionFrozen, TodayPosition, CashIn, CashOut, Margin, Commission, StampTax, TransferFee, FrozenCash, FrozenMargin, FrozenCommission, FrozenStampTax, FrozenTransferFee, MarketValue, VolumeMultiple, CloseProfit, CloseProfitFloat, PositionProfit, PositionProfitFloat, LastPrice, PrePrice);
		return t_MdbDataStringBuffer;
	}
	int Position::GetSqlString(char* buff) const
	{
		return sprintf(buff, "\n('%s','%s','%d','%s','%s','%d','%d','%lld','%lld','%lld','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%f','%d','%f','%f','%f','%f','%f','%f'),",
			TradingDay, AccountID, (int)AccountType, ExchangeID, InstrumentID, (int)SecurityType, (int)PosiDirection, TotalPosition, PositionFrozen, TodayPosition, CashIn, CashOut, Margin, Commission, StampTax, TransferFee, FrozenCash, FrozenMargin, FrozenCommission, FrozenStampTax, FrozenTransferFee, MarketValue, VolumeMultiple, CloseProfit, CloseProfitFloat, PositionProfit, PositionProfitFloat, LastPrice, PrePrice);
	}
	const char* Position::GetDebugString() const
	{
		sprintf(t_MdbDataStringBuffer, "Position:TradingDay:[%s], AccountID:[%s], AccountType:[%d], ExchangeID:[%s], InstrumentID:[%s], SecurityType:[%d], PosiDirection:[%d], TotalPosition:[%lld], PositionFrozen:[%lld], TodayPosition:[%lld], CashIn:[%f], CashOut:[%f], Margin:[%f], Commission:[%f], StampTax:[%f], TransferFee:[%f], FrozenCash:[%f], FrozenMargin:[%f], FrozenCommission:[%f], FrozenStampTax:[%f], FrozenTransferFee:[%f], MarketValue:[%f], VolumeMultiple:[%d], CloseProfit:[%f], CloseProfitFloat:[%f], PositionProfit:[%f], PositionProfitFloat:[%f], LastPrice:[%f], PrePrice:[%f]",
			TradingDay, AccountID, (int)AccountType, ExchangeID, InstrumentID, (int)SecurityType, (int)PosiDirection, TotalPosition, PositionFrozen, TodayPosition, CashIn, CashOut, Margin, Commission, StampTax, TransferFee, FrozenCash, FrozenMargin, FrozenCommission, FrozenStampTax, FrozenTransferFee, MarketValue, VolumeMultiple, CloseProfit, CloseProfitFloat, PositionProfit, PositionProfitFloat, LastPrice, PrePrice);
		return t_MdbDataStringBuffer;
	}
	...
	{
		sprintf(t_MdbDataStringBuffer, "%s,%s,%s,%d,%s,%s,%d,%d,%s,%d,%d,%d,%f,%lld,%lld,%lld,%d,%d,%s,%s,%s,%s,%lld,%d,%d,%d,%d,%d,%d,%f,%f,%f,%f,%f,%d,%d",
			TradingDay, AccountID, PrimaryAccountID, (int)AccountType, ExchangeID, InstrumentID, (int)SecurityType, OrderID, OrderSysID, (int)Direction, (int)OffsetFlag, (int)OrderPriceType, Price, Volume, VolumeTotal, VolumeTraded, VolumeMultiple, (int)OrderStatus, OrderDate, OrderTime, CancelDate, CancelTime, SessionID, ClientOrderID, RequestID, OfferID, TradeGroupID, RiskGroupID, CommissionGroupID, FrozenCash, FrozenMargin, FrozenCommission, FrozenStampTax, FrozenTransferFee, RebuildMark, IsForceClose);
		return t_MdbDataStringBuffer;
	}
	int Order::GetSqlString(char* buff) const
	{
		return sprintf(buff, "\n('%s','%s','%s','%d','%s','%s','%d','%d','%s','%d','%d','%d','%f','%lld','%lld','%lld','%d','%d','%s','%s','%s','%s','%lld','%d','%d','%d','%d','%d','%d','%f','%f','%f','%f','%f','%d','%d'),",
			TradingDay, AccountID, PrimaryAccountID, (int)AccountType, ExchangeID, InstrumentID, (int)SecurityType, OrderID, OrderSysID, (int)Direction, (int)OffsetFlag, (int)OrderPriceType, Price, Volume, VolumeTotal, VolumeTraded, VolumeMultiple, (int)OrderStatus, OrderDate, OrderTime, CancelDate, CancelTime, SessionID, ClientOrderID, RequestID, OfferID, TradeGroupID, RiskGroupID, CommissionGroupID, FrozenCash, FrozenMargin, FrozenCommission, FrozenStampTax, FrozenTransferFee, RebuildMark, IsForceClose);
	}
	const char* Order::GetDebugString() const
	{
		sprintf(t_MdbDataStringBuffer, "Order:TradingDay:[%s], AccountID:[%s], PrimaryAccountID:[%s], AccountType:[%d], ExchangeID:[%s], InstrumentID:[%s], SecurityType:[%d], OrderID:[%d], OrderSysID:[%s], Direction:[%d], OffsetFlag:[%d], OrderPriceType:[%d], Price:[%f], Volume:[%lld], VolumeTotal:[%lld], VolumeTraded:[%lld], VolumeMultiple:[%d], OrderStatus:[%d], OrderDate:[%s], OrderTime:[%s], CancelDate:[%s], CancelTime:[%s], SessionID:[%lld], ClientOrderID:[%d], RequestID:[%d], OfferID:[%d], TradeGroupID:[%d], RiskGroupID:[%d], CommissionGroupID:[%d], FrozenCash:[%f], FrozenMargin:[%f], FrozenCommission:[%f], FrozenStampTax:[%f], FrozenTransferFee:[%f], RebuildMark:[%d], IsForceClose:[%d]",
			TradingDay, AccountID, PrimaryAccountID, (int)AccountType, ExchangeID, InstrumentID, (int)SecurityType, OrderID, OrderSysID, (int)Direction, (int)OffsetFlag, (int)OrderPriceType, Price, Volume, VolumeTotal, VolumeTraded, VolumeMultiple, (int)OrderStatus, OrderDate, OrderTime, CancelDate, CancelTime, SessionID, ClientOrderID, RequestID, OfferID, TradeGroupID, RiskGroupID, CommissionGroupID, FrozenCash, FrozenMargin, FrozenCommission, FrozenStampTax, FrozenTransferFee, RebuildMark, IsForceClose);
		return t_MdbDataStringBuffer;
	}
	...
	{
		sprintf(t_MdbDataStringBuffer, "%s,%s,%s,%d,%s,%s,%d,%d,%s,%s,%d,%d,%f,%lld,%d,%f,%f,%f,%f,%s,%s",
			TradingDay, AccountID, PrimaryAccountID, (int)AccountType, ExchangeID, InstrumentID, (int)SecurityType, OrderID, OrderSysID, TradeID, (int)Direction, (int)OffsetFlag, Price, Volume, VolumeMultiple, TradeAmount, Commission, StampTax, TransferFee, TradeDate, TradeTime);
		return t_MdbDataStringBuffer;
	}
	int Trade::GetSqlString(char* buff) const
	{
		return sprintf(buff, "\n('%s','%s','%s','%d','%s','%s','%d','%d','%s','%s','%d','%d','%f','%lld','%d','%f','%f','%f','%f','%s','%s'),",
			TradingDay, AccountID, PrimaryAccountID, (int)AccountType, ExchangeID, InstrumentID, (int)SecurityType, OrderID, OrderSysID, TradeID, (int)Direction, (int)OffsetFlag, Price, Volume, VolumeMultiple, TradeAmount, Commission, StampTax, TransferFee, TradeDate, TradeTime);
	}
	const char* Trade::GetDebugString() const
	{
		sprintf(t_MdbDataStringBuffer, "Trade:TradingDay:[%s], AccountID:[%s], PrimaryAccountID:[%s], AccountType:[%d], ExchangeID:[%s], InstrumentID:[%s], SecurityType:[%d], OrderID:[%d], OrderSysID:[%s], TradeID:[%s], Direction:[%d], OffsetFlag:[%d], Price:[%f], Volume:[%lld], VolumeMultiple:[%d], TradeAmount:[%f], Commission:[%f], StampTax:[%f], TransferFee:[%f], TradeDate:[%s], TradeTime:[%s]",
			TradingDay, AccountID, PrimaryAccountID, (int)AccountType, ExchangeID, InstrumentID, (int)SecurityType, OrderID, OrderSysID, TradeID, (int)Direction, (int)OffsetFlag, Price, Volume, VolumeMultiple, TradeAmount, Commission, StampTax, TransferFee, TradeDate, TradeTime);
		return t_MdbDataStringBuffer;
	}
