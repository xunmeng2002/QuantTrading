...
constexpr const char* CreateDuckDBBarMarketDataTableSqlString = "CREATE TABLE IF NOT EXISTS t_BarMarketData(TradingDay varchar, ExchangeID varchar, InstrumentID varchar, BarPreces int, BarPeriod int, BarTime bigint, UpdateTs bigint, PreSettlementPrice double, PreClosePrice double, HighestPrice double, LowestPrice double, Open double, High double, Low double, Close double, CurrVolume bigint, Volume bigint, CurrTurnover double, Turnover double, OpenInterest double, PRIMARY KEY(TradingDay, ExchangeID, InstrumentID, BarPreces, BarPeriod, BarTime));";
...
constexpr const char* CreateDuckDBAccountLoginSessionTableSqlString = "CREATE TABLE IF NOT EXISTS t_AccountLoginSession(AccountID varchar, SessionID bigint, IPAddress varchar, PRIMARY KEY(SessionID)); CREATE INDEX IF NOT EXISTS AccountIDIndex ON t_AccountLoginSession(AccountID);";
constexpr const char* TruncateDuckDBAccountLoginSessionTableSqlString = "Delete From t_AccountLoginSession;";
