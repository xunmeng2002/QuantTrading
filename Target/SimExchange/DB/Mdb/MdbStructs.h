...
namespace mdb
{
	...
	{
	public:
		static constexpr unsigned int TableID = 0x3A01;
		//经纪公司代码
	...
	{
	public:
		static constexpr unsigned int TableID = 0x3A02;
		//交易所代码
		ExchangeIDType ExchangeID;
		//合约代码
		InstrumentIDType InstrumentID;
	...
	{
	public:
		static constexpr unsigned int TableID = 0x3A03;
		//交易日
		DateType TradingDay;
		//经纪公司代码
		BrokerIDType BrokerID;
	...
	{
	public:
		static constexpr unsigned int TableID = 0x3A04;
		//交易日
		DateType TradingDay;
		//经纪公司代码
		BrokerIDType BrokerID;
	...
	{
	public:
		static constexpr unsigned int TableID = 0x3A05;
		//经纪公司代码
		BrokerIDType BrokerID;
		//会话编号
		SessionIDType SessionID;
