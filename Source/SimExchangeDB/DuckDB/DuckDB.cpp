...
void DuckDB::SetStatementForInstrumentRecord(duckdb_prepared_statement statement, Instrument* record)
{
	...
	duckdb_bind_int64(statement, 8, record->MaxMarketOrderVolume);
	duckdb_bind_int64(statement, 9, record->MinMarketOrderVolume);
	duckdb_bind_int64(statement, 10, record->MaxLimitOrderVolume);
	duckdb_bind_int64(statement, 11, record->MinLimitOrderVolume);
...
void DuckDB::SetStatementForInstrumentRecordUpdate(duckdb_prepared_statement statement, Instrument* record)
{
	...
	duckdb_bind_int64(statement, 6, record->MaxMarketOrderVolume);
	duckdb_bind_int64(statement, 7, record->MinMarketOrderVolume);
	duckdb_bind_int64(statement, 8, record->MaxLimitOrderVolume);
	duckdb_bind_int64(statement, 9, record->MinLimitOrderVolume);
...
bool DuckDB::AppendForPositionRecord(duckdb_appender appender, Position* record)
{
	...
	duckdb_append_int64(appender, record->FrozenPosition);
	duckdb_append_double(appender, record->CloseProfitByDate);
...
void DuckDB::SetStatementForPositionRecord(duckdb_prepared_statement statement, Position* record)
{
	...
	duckdb_bind_int64(statement, 7, record->TotalPosition);
	duckdb_bind_int64(statement, 8, record->TodayPosition);
	duckdb_bind_int64(statement, 9, record->FrozenPosition);
...
void DuckDB::SetStatementForPositionRecordUpdate(duckdb_prepared_statement statement, Position* record)
{
	...
	duckdb_bind_int64(statement, 2, record->TotalPosition);
	duckdb_bind_int64(statement, 3, record->TodayPosition);
	duckdb_bind_int64(statement, 4, record->FrozenPosition);
...
bool DuckDB::AppendForOrderRecord(duckdb_appender appender, Order* record)
{
	...
	duckdb_append_int64(appender, record->VolumeRemain);
...
void DuckDB::SetStatementForOrderRecord(duckdb_prepared_statement statement, Order* record)
{
	...
	duckdb_bind_int64(statement, 12, record->VolumeRemain);
	duckdb_bind_int64(statement, 13, record->VolumeTraded);
...
void DuckDB::SetStatementForOrderRecordUpdate(duckdb_prepared_statement statement, Order* record)
{
	...
	duckdb_bind_int64(statement, 7, record->VolumeRemain);
	duckdb_bind_int64(statement, 8, record->VolumeTraded);
...
void DuckDB::SetStatementForMdTickRecord(duckdb_prepared_statement statement, MdTick* record)
{
	...
	duckdb_bind_int64(statement, 23, record->AskVolume1);
	duckdb_bind_int64(statement, 24, record->AskVolume2);
	duckdb_bind_int64(statement, 25, record->AskVolume3);
	duckdb_bind_int64(statement, 26, record->AskVolume4);
	duckdb_bind_int64(statement, 27, record->AskVolume5);
	...
	duckdb_bind_int64(statement, 33, record->BidVolume1);
	duckdb_bind_int64(statement, 34, record->BidVolume2);
	duckdb_bind_int64(statement, 35, record->BidVolume3);
	duckdb_bind_int64(statement, 36, record->BidVolume4);
	duckdb_bind_int64(statement, 37, record->BidVolume5);
...
void DuckDB::SetStatementForMdTickRecordUpdate(duckdb_prepared_statement statement, MdTick* record)
{
	...
	duckdb_bind_int64(statement, 10, record->OpenInterest);
	...
	duckdb_bind_int64(statement, 20, record->AskVolume1);
	duckdb_bind_int64(statement, 21, record->AskVolume2);
	duckdb_bind_int64(statement, 22, record->AskVolume3);
	duckdb_bind_int64(statement, 23, record->AskVolume4);
	duckdb_bind_int64(statement, 24, record->AskVolume5);
	...
	duckdb_bind_int64(statement, 30, record->BidVolume1);
	duckdb_bind_int64(statement, 31, record->BidVolume2);
	duckdb_bind_int64(statement, 32, record->BidVolume3);
	duckdb_bind_int64(statement, 33, record->BidVolume4);
	duckdb_bind_int64(statement, 34, record->BidVolume5);
...
void DuckDB::ParseRecord(duckdb_result& result, std::vector<MdTick*>& records)
{
	while (true)
	{
		...
		int64_t* dataColumn24 = (int64_t*)duckdb_vector_get_data(column24);
		int64_t* dataColumn25 = (int64_t*)duckdb_vector_get_data(column25);
		int64_t* dataColumn26 = (int64_t*)duckdb_vector_get_data(column26);
