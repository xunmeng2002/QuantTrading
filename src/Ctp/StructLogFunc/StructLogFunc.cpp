...
void WriteReqUserLogin(CThostFtdcReqUserLoginField* ReqUserLogin)
{
	if(ReqUserLogin)
	{
		WriteLog(LogLevel::Info, "CThostFtdcReqUserLoginField: TradingDay[%s], BrokerID[%s], UserID[%s], UserProductInfo[%s], InterfaceProductInfo[%s], ProtocolInfo[%s], MacAddress[%s], reserve1[%s], LoginRemark[%s], ClientIPPort[%d], ClientIPAddress[%s]",
			ReqUserLogin->TradingDay, ReqUserLogin->BrokerID, ReqUserLogin->UserID, ReqUserLogin->UserProductInfo, ReqUserLogin->InterfaceProductInfo, ReqUserLogin->ProtocolInfo, ReqUserLogin->MacAddress, ReqUserLogin->reserve1, ReqUserLogin->LoginRemark, ReqUserLogin->ClientIPPort, ReqUserLogin->ClientIPAddress);
	}
}
...
void WriteReqAuthenticate(CThostFtdcReqAuthenticateField* ReqAuthenticate)
{
	if(ReqAuthenticate)
	{
		WriteLog(LogLevel::Info, "CThostFtdcReqAuthenticateField: BrokerID[%s], UserID[%s], UserProductInfo[%s], AppID[%s]",
			ReqAuthenticate->BrokerID, ReqAuthenticate->UserID, ReqAuthenticate->UserProductInfo, ReqAuthenticate->AppID);
	}
}
...
void WriteAuthenticationInfo(CThostFtdcAuthenticationInfoField* AuthenticationInfo)
{
	...
	{
		WriteLog(LogLevel::Info, "CThostFtdcAuthenticationInfoField: BrokerID[%s], UserID[%s], UserProductInfo[%s], IsResult[%d], AppID[%s], AppType[%c], reserve1[%s], ClientIPAddress[%s]",
			AuthenticationInfo->BrokerID, AuthenticationInfo->UserID, AuthenticationInfo->UserProductInfo, AuthenticationInfo->IsResult, AuthenticationInfo->AppID, AuthenticationInfo->AppType, AuthenticationInfo->reserve1, AuthenticationInfo->ClientIPAddress);
	}
}
...
void WriteTransferBankToFutureReq(CThostFtdcTransferBankToFutureReqField* TransferBankToFutureReq)
{
	...
	{
		WriteLog(LogLevel::Info, "CThostFtdcTransferBankToFutureReqField: FutureAccount[%s], FuturePwdFlag[%c], TradeAmt[%f], CustFee[%f], CurrencyCode[%s]",
			TransferBankToFutureReq->FutureAccount, TransferBankToFutureReq->FuturePwdFlag, GetDoubleValue(TransferBankToFutureReq->TradeAmt), GetDoubleValue(TransferBankToFutureReq->CustFee), TransferBankToFutureReq->CurrencyCode);
	}
}
...
void WriteTransferFutureToBankReq(CThostFtdcTransferFutureToBankReqField* TransferFutureToBankReq)
{
	...
	{
		WriteLog(LogLevel::Info, "CThostFtdcTransferFutureToBankReqField: FutureAccount[%s], FuturePwdFlag[%c], TradeAmt[%f], CustFee[%f], CurrencyCode[%s]",
			TransferFutureToBankReq->FutureAccount, TransferFutureToBankReq->FuturePwdFlag, GetDoubleValue(TransferFutureToBankReq->TradeAmt), GetDoubleValue(TransferFutureToBankReq->CustFee), TransferFutureToBankReq->CurrencyCode);
	}
}
...
void WriteTransferQryBankReq(CThostFtdcTransferQryBankReqField* TransferQryBankReq)
{
	...
	{
		WriteLog(LogLevel::Info, "CThostFtdcTransferQryBankReqField: FutureAccount[%s], FuturePwdFlag[%c], CurrencyCode[%s]",
			TransferQryBankReq->FutureAccount, TransferQryBankReq->FuturePwdFlag, TransferQryBankReq->CurrencyCode);
	}
}
...
void WriteTrader(CThostFtdcTraderField* Trader)
{
	if(Trader)
	{
		WriteLog(LogLevel::Info, "CThostFtdcTraderField: ExchangeID[%s], TraderID[%s], ParticipantID[%s], InstallCount[%d], BrokerID[%s], OrderCancelAlg[%c], TradeInstallCount[%d], MDInstallCount[%d]",
			Trader->ExchangeID, Trader->TraderID, Trader->ParticipantID, Trader->InstallCount, Trader->BrokerID, Trader->OrderCancelAlg, Trader->TradeInstallCount, Trader->MDInstallCount);
	}
}
...
void WriteSuperUser(CThostFtdcSuperUserField* SuperUser)
{
	if(SuperUser)
	{
		WriteLog(LogLevel::Info, "CThostFtdcSuperUserField: UserID[%s], UserName[%s], IsActive[%d]",
			SuperUser->UserID, SuperUser->UserName, SuperUser->IsActive);
	}
}
...
void WriteBrokerUserPassword(CThostFtdcBrokerUserPasswordField* BrokerUserPassword)
{
	...
	{
		WriteLog(LogLevel::Info, "CThostFtdcBrokerUserPasswordField: BrokerID[%s], UserID[%s], LastUpdateTime[%s], LastLoginTime[%s], ExpireDate[%s], WeakExpireDate[%s]",
			BrokerUserPassword->BrokerID, BrokerUserPassword->UserID, BrokerUserPassword->LastUpdateTime, BrokerUserPassword->LastLoginTime, BrokerUserPassword->ExpireDate, BrokerUserPassword->WeakExpireDate);
	}
}
...
void WriteTraderOffer(CThostFtdcTraderOfferField* TraderOffer)
{
	if(TraderOffer)
	{
		WriteLog(LogLevel::Info, "CThostFtdcTraderOfferField: ExchangeID[%s], TraderID[%s], ParticipantID[%s], InstallID[%d], OrderLocalID[%s], TraderConnectStatus[%c], ConnectRequestDate[%s], ConnectRequestTime[%s], LastReportDate[%s], LastReportTime[%s], ConnectDate[%s], ConnectTime[%s], StartDate[%s], StartTime[%s], TradingDay[%s], BrokerID[%s], MaxTradeID[%s], MaxOrderMessageReference[%s], OrderCancelAlg[%c]",
			TraderOffer->ExchangeID, TraderOffer->TraderID, TraderOffer->ParticipantID, TraderOffer->InstallID, TraderOffer->OrderLocalID, TraderOffer->TraderConnectStatus, TraderOffer->ConnectRequestDate, TraderOffer->ConnectRequestTime, TraderOffer->LastReportDate, TraderOffer->LastReportTime, TraderOffer->ConnectDate, TraderOffer->ConnectTime, TraderOffer->StartDate, TraderOffer->StartTime, TraderOffer->TradingDay, TraderOffer->BrokerID, TraderOffer->MaxTradeID, TraderOffer->MaxOrderMessageReference, TraderOffer->OrderCancelAlg);
	}
}
...
void WriteLoginInfo(CThostFtdcLoginInfoField* LoginInfo)
{
	if(LoginInfo)
	{
		WriteLog(LogLevel::Info, "CThostFtdcLoginInfoField: FrontID[%d], SessionID[%d], BrokerID[%s], UserID[%s], LoginDate[%s], LoginTime[%s], reserve1[%s], UserProductInfo[%s], InterfaceProductInfo[%s], ProtocolInfo[%s], SystemName[%s], MaxOrderRef[%s], SHFETime[%s], DCETime[%s], CZCETime[%s], FFEXTime[%s], MacAddress[%s], INETime[%s], IsQryControl[%d], LoginRemark[%s], IPAddress[%s]",
			LoginInfo->FrontID, LoginInfo->SessionID, LoginInfo->BrokerID, LoginInfo->UserID, LoginInfo->LoginDate, LoginInfo->LoginTime, LoginInfo->reserve1, LoginInfo->UserProductInfo, LoginInfo->InterfaceProductInfo, LoginInfo->ProtocolInfo, LoginInfo->SystemName, LoginInfo->MaxOrderRef, LoginInfo->SHFETime, LoginInfo->DCETime, LoginInfo->CZCETime, LoginInfo->FFEXTime, LoginInfo->MacAddress, LoginInfo->INETime, LoginInfo->IsQryControl, LoginInfo->LoginRemark, LoginInfo->IPAddress);
	}
}
...
void WriteUserPasswordUpdate(CThostFtdcUserPasswordUpdateField* UserPasswordUpdate)
{
	...
	{
		WriteLog(LogLevel::Info, "CThostFtdcUserPasswordUpdateField: BrokerID[%s], UserID[%s]",
			UserPasswordUpdate->BrokerID, UserPasswordUpdate->UserID);
	}
}
...
void WriteSyncDeposit(CThostFtdcSyncDepositField* SyncDeposit)
{
	if(SyncDeposit)
	{
		WriteLog(LogLevel::Info, "CThostFtdcSyncDepositField: DepositSeqNo[%s], BrokerID[%s], InvestorID[%s], Deposit[%f], IsForce[%d], CurrencyID[%s], IsFromSopt[%d], IsSecAgentTranfer[%d]",
			SyncDeposit->DepositSeqNo, SyncDeposit->BrokerID, SyncDeposit->InvestorID, GetDoubleValue(SyncDeposit->Deposit), SyncDeposit->IsForce, SyncDeposit->CurrencyID, SyncDeposit->IsFromSopt, SyncDeposit->IsSecAgentTranfer);
	}
}
...
void WriteTradingAccountPassword(CThostFtdcTradingAccountPasswordField* TradingAccountPassword)
{
	...
	{
		WriteLog(LogLevel::Info, "CThostFtdcTradingAccountPasswordField: BrokerID[%s], AccountID[%s], CurrencyID[%s]",
			TradingAccountPassword->BrokerID, TradingAccountPassword->AccountID, TradingAccountPassword->CurrencyID);
	}
}
...
void WriteTradingAccountPasswordUpdateV1(CThostFtdcTradingAccountPasswordUpdateV1Field* TradingAccountPasswordUpdateV1)
{
	...
	{
		WriteLog(LogLevel::Info, "CThostFtdcTradingAccountPasswordUpdateV1Field: BrokerID[%s], InvestorID[%s]",
			TradingAccountPasswordUpdateV1->BrokerID, TradingAccountPasswordUpdateV1->InvestorID);
	}
}
void WriteTradingAccountPasswordUpdate(CThostFtdcTradingAccountPasswordUpdateField* TradingAccountPasswordUpdate)
{
	...
	{
		WriteLog(LogLevel::Info, "CThostFtdcTradingAccountPasswordUpdateField: BrokerID[%s], AccountID[%s], CurrencyID[%s]",
			TradingAccountPasswordUpdate->BrokerID, TradingAccountPasswordUpdate->AccountID, TradingAccountPasswordUpdate->CurrencyID);
	}
}
...
void WriteVerifyInvestorPassword(CThostFtdcVerifyInvestorPasswordField* VerifyInvestorPassword)
{
	...
	{
		WriteLog(LogLevel::Info, "CThostFtdcVerifyInvestorPasswordField: BrokerID[%s], InvestorID[%s]",
			VerifyInvestorPassword->BrokerID, VerifyInvestorPassword->InvestorID);
	}
}
...
void WriteCFMMCBrokerKey(CThostFtdcCFMMCBrokerKeyField* CFMMCBrokerKey)
{
	if(CFMMCBrokerKey)
	{
		WriteLog(LogLevel::Info, "CThostFtdcCFMMCBrokerKeyField: BrokerID[%s], ParticipantID[%s], CreateDate[%s], CreateTime[%s], KeyID[%d], KeyKind[%c]",
			CFMMCBrokerKey->BrokerID, CFMMCBrokerKey->ParticipantID, CFMMCBrokerKey->CreateDate, CFMMCBrokerKey->CreateTime, CFMMCBrokerKey->KeyID, CFMMCBrokerKey->KeyKind);
	}
}
void WriteCFMMCTradingAccountKey(CThostFtdcCFMMCTradingAccountKeyField* CFMMCTradingAccountKey)
{
	...
	{
		WriteLog(LogLevel::Info, "CThostFtdcCFMMCTradingAccountKeyField: BrokerID[%s], ParticipantID[%s], AccountID[%s], KeyID[%d]",
			CFMMCTradingAccountKey->BrokerID, CFMMCTradingAccountKey->ParticipantID, CFMMCTradingAccountKey->AccountID, CFMMCTradingAccountKey->KeyID);
	}
}
...
void WriteBrokerUserOTPParam(CThostFtdcBrokerUserOTPParamField* BrokerUserOTPParam)
{
	...
	{
		WriteLog(LogLevel::Info, "CThostFtdcBrokerUserOTPParamField: BrokerID[%s], UserID[%s], OTPVendorsID[%s], SerialNumber[%s], LastDrift[%d], LastSuccess[%d], OTPType[%c]",
			BrokerUserOTPParam->BrokerID, BrokerUserOTPParam->UserID, BrokerUserOTPParam->OTPVendorsID, BrokerUserOTPParam->SerialNumber, BrokerUserOTPParam->LastDrift, BrokerUserOTPParam->LastSuccess, BrokerUserOTPParam->OTPType);
	}
}
void WriteManualSyncBrokerUserOTP(CThostFtdcManualSyncBrokerUserOTPField* ManualSyncBrokerUserOTP)
{
	...
	{
		WriteLog(LogLevel::Info, "CThostFtdcManualSyncBrokerUserOTPField: BrokerID[%s], UserID[%s], OTPType[%c]",
			ManualSyncBrokerUserOTP->BrokerID, ManualSyncBrokerUserOTP->UserID, ManualSyncBrokerUserOTP->OTPType);
	}
}
...
void WriteCFMMCTradingAccountToken(CThostFtdcCFMMCTradingAccountTokenField* CFMMCTradingAccountToken)
{
	...
	{
		WriteLog(LogLevel::Info, "CThostFtdcCFMMCTradingAccountTokenField: BrokerID[%s], ParticipantID[%s], AccountID[%s], KeyID[%d]",
			CFMMCTradingAccountToken->BrokerID, CFMMCTradingAccountToken->ParticipantID, CFMMCTradingAccountToken->AccountID, CFMMCTradingAccountToken->KeyID);
	}
}
...
void WriteReqOpenAccount(CThostFtdcReqOpenAccountField* ReqOpenAccount)
{
	if(ReqOpenAccount)
	{
		WriteLog(LogLevel::Info, "CThostFtdcReqOpenAccountField: TradeCode[%s], BankID[%s], BankBranchID[%s], BrokerID[%s], BrokerBranchID[%s], TradeDate[%s], TradeTime[%s], BankSerial[%s], TradingDay[%s], PlateSerial[%d], LastFragment[%c], SessionID[%d], CustomerName[%s], IdCardType[%c], IdentifiedCardNo[%s], Gender[%c], CountryCode[%s], CustType[%c], Address[%s], ZipCode[%s], Telephone[%s], MobilePhone[%s], Fax[%s], EMail[%s], MoneyAccountStatus[%c], BankAccount[%s], AccountID[%s], InstallID[%d], VerifyCertNoFlag[%c], CurrencyID[%s], CashExchangeCode[%c], Digest[%s], BankAccType[%c], DeviceID[%s], BankSecuAccType[%c], BrokerIDByBank[%s], BankSecuAcc[%s], BankPwdFlag[%c], SecuPwdFlag[%c], OperNo[%s], TID[%d], UserID[%s], LongCustomerName[%s]",
			ReqOpenAccount->TradeCode, ReqOpenAccount->BankID, ReqOpenAccount->BankBranchID, ReqOpenAccount->BrokerID, ReqOpenAccount->BrokerBranchID, ReqOpenAccount->TradeDate, ReqOpenAccount->TradeTime, ReqOpenAccount->BankSerial, ReqOpenAccount->TradingDay, ReqOpenAccount->PlateSerial, ReqOpenAccount->LastFragment, ReqOpenAccount->SessionID, ReqOpenAccount->CustomerName, ReqOpenAccount->IdCardType, ReqOpenAccount->IdentifiedCardNo, ReqOpenAccount->Gender, ReqOpenAccount->CountryCode, ReqOpenAccount->CustType, ReqOpenAccount->Address, ReqOpenAccount->ZipCode, ReqOpenAccount->Telephone, ReqOpenAccount->MobilePhone, ReqOpenAccount->Fax, ReqOpenAccount->EMail, ReqOpenAccount->MoneyAccountStatus, ReqOpenAccount->BankAccount, ReqOpenAccount->AccountID, ReqOpenAccount->InstallID, ReqOpenAccount->VerifyCertNoFlag, ReqOpenAccount->CurrencyID, ReqOpenAccount->CashExchangeCode, ReqOpenAccount->Digest, ReqOpenAccount->BankAccType, ReqOpenAccount->DeviceID, ReqOpenAccount->BankSecuAccType, ReqOpenAccount->BrokerIDByBank, ReqOpenAccount->BankSecuAcc, ReqOpenAccount->BankPwdFlag, ReqOpenAccount->SecuPwdFlag, ReqOpenAccount->OperNo, ReqOpenAccount->TID, ReqOpenAccount->UserID, ReqOpenAccount->LongCustomerName);
	}
}
...
void WriteVerifyFuturePassword(CThostFtdcVerifyFuturePasswordField* VerifyFuturePassword)
{
	...
	{
		WriteLog(LogLevel::Info, "CThostFtdcVerifyFuturePasswordField: TradeCode[%s], BankID[%s], BankBranchID[%s], BrokerID[%s], BrokerBranchID[%s], TradeDate[%s], TradeTime[%s], BankSerial[%s], TradingDay[%s], PlateSerial[%d], LastFragment[%c], SessionID[%d], AccountID[%s], BankAccount[%s], InstallID[%d], TID[%d], CurrencyID[%s]",
			VerifyFuturePassword->TradeCode, VerifyFuturePassword->BankID, VerifyFuturePassword->BankBranchID, VerifyFuturePassword->BrokerID, VerifyFuturePassword->BrokerBranchID, VerifyFuturePassword->TradeDate, VerifyFuturePassword->TradeTime, VerifyFuturePassword->BankSerial, VerifyFuturePassword->TradingDay, VerifyFuturePassword->PlateSerial, VerifyFuturePassword->LastFragment, VerifyFuturePassword->SessionID, VerifyFuturePassword->AccountID, VerifyFuturePassword->BankAccount, VerifyFuturePassword->InstallID, VerifyFuturePassword->TID, VerifyFuturePassword->CurrencyID);
	}
}
...
void WriteVerifyFuturePasswordAndCustInfo(CThostFtdcVerifyFuturePasswordAndCustInfoField* VerifyFuturePasswordAndCustInfo)
{
	...
	{
		WriteLog(LogLevel::Info, "CThostFtdcVerifyFuturePasswordAndCustInfoField: CustomerName[%s], IdCardType[%c], IdentifiedCardNo[%s], CustType[%c], AccountID[%s], CurrencyID[%s], LongCustomerName[%s]",
			VerifyFuturePasswordAndCustInfo->CustomerName, VerifyFuturePasswordAndCustInfo->IdCardType, VerifyFuturePasswordAndCustInfo->IdentifiedCardNo, VerifyFuturePasswordAndCustInfo->CustType, VerifyFuturePasswordAndCustInfo->AccountID, VerifyFuturePasswordAndCustInfo->CurrencyID, VerifyFuturePasswordAndCustInfo->LongCustomerName);
	}
}
...
void WriteReqUserLoginWithCaptcha(CThostFtdcReqUserLoginWithCaptchaField* ReqUserLoginWithCaptcha)
{
	...
	{
		WriteLog(LogLevel::Info, "CThostFtdcReqUserLoginWithCaptchaField: TradingDay[%s], BrokerID[%s], UserID[%s], UserProductInfo[%s], InterfaceProductInfo[%s], ProtocolInfo[%s], MacAddress[%s], reserve1[%s], LoginRemark[%s], ClientIPPort[%d], ClientIPAddress[%s]",
			ReqUserLoginWithCaptcha->TradingDay, ReqUserLoginWithCaptcha->BrokerID, ReqUserLoginWithCaptcha->UserID, ReqUserLoginWithCaptcha->UserProductInfo, ReqUserLoginWithCaptcha->InterfaceProductInfo, ReqUserLoginWithCaptcha->ProtocolInfo, ReqUserLoginWithCaptcha->MacAddress, ReqUserLoginWithCaptcha->reserve1, ReqUserLoginWithCaptcha->LoginRemark, ReqUserLoginWithCaptcha->ClientIPPort, ReqUserLoginWithCaptcha->ClientIPAddress);
	}
}
void WriteReqUserLoginWithText(CThostFtdcReqUserLoginWithTextField* ReqUserLoginWithText)
{
	...
	{
		WriteLog(LogLevel::Info, "CThostFtdcReqUserLoginWithTextField: TradingDay[%s], BrokerID[%s], UserID[%s], UserProductInfo[%s], InterfaceProductInfo[%s], ProtocolInfo[%s], MacAddress[%s], reserve1[%s], LoginRemark[%s], ClientIPPort[%d], ClientIPAddress[%s]",
			ReqUserLoginWithText->TradingDay, ReqUserLoginWithText->BrokerID, ReqUserLoginWithText->UserID, ReqUserLoginWithText->UserProductInfo, ReqUserLoginWithText->InterfaceProductInfo, ReqUserLoginWithText->ProtocolInfo, ReqUserLoginWithText->MacAddress, ReqUserLoginWithText->reserve1, ReqUserLoginWithText->LoginRemark, ReqUserLoginWithText->ClientIPPort, ReqUserLoginWithText->ClientIPAddress);
	}
}
void WriteReqUserLoginWithOTP(CThostFtdcReqUserLoginWithOTPField* ReqUserLoginWithOTP)
{
	...
	{
		WriteLog(LogLevel::Info, "CThostFtdcReqUserLoginWithOTPField: TradingDay[%s], BrokerID[%s], UserID[%s], UserProductInfo[%s], InterfaceProductInfo[%s], ProtocolInfo[%s], MacAddress[%s], reserve1[%s], LoginRemark[%s], ClientIPPort[%d], ClientIPAddress[%s]",
			ReqUserLoginWithOTP->TradingDay, ReqUserLoginWithOTP->BrokerID, ReqUserLoginWithOTP->UserID, ReqUserLoginWithOTP->UserProductInfo, ReqUserLoginWithOTP->InterfaceProductInfo, ReqUserLoginWithOTP->ProtocolInfo, ReqUserLoginWithOTP->MacAddress, ReqUserLoginWithOTP->reserve1, ReqUserLoginWithOTP->LoginRemark, ReqUserLoginWithOTP->ClientIPPort, ReqUserLoginWithOTP->ClientIPAddress);
	}
}
...
void WriteReqUserLoginSM(CThostFtdcReqUserLoginSMField* ReqUserLoginSM)
{
	if(ReqUserLoginSM)
	{
		WriteLog(LogLevel::Info, "CThostFtdcReqUserLoginSMField: TradingDay[%s], BrokerID[%s], UserID[%s], UserProductInfo[%s], InterfaceProductInfo[%s], ProtocolInfo[%s], MacAddress[%s], reserve1[%s], LoginRemark[%s], ClientIPPort[%d], ClientIPAddress[%s], BrokerName[%s], AppID[%s]",
			ReqUserLoginSM->TradingDay, ReqUserLoginSM->BrokerID, ReqUserLoginSM->UserID, ReqUserLoginSM->UserProductInfo, ReqUserLoginSM->InterfaceProductInfo, ReqUserLoginSM->ProtocolInfo, ReqUserLoginSM->MacAddress, ReqUserLoginSM->reserve1, ReqUserLoginSM->LoginRemark, ReqUserLoginSM->ClientIPPort, ReqUserLoginSM->ClientIPAddress, ReqUserLoginSM->BrokerName, ReqUserLoginSM->AppID);
	}
}
...
void WriteUserPasswordUpdateFromSec(CThostFtdcUserPasswordUpdateFromSecField* UserPasswordUpdateFromSec)
{
	...
	{
		WriteLog(LogLevel::Info, "CThostFtdcUserPasswordUpdateFromSecField: BrokerID[%s], UserID[%s], FromSec[%d]",
			UserPasswordUpdateFromSec->BrokerID, UserPasswordUpdateFromSec->UserID, UserPasswordUpdateFromSec->FromSec);
	}
}
...
void WriteTradingAccountPasswordUpdateFromSec(CThostFtdcTradingAccountPasswordUpdateFromSecField* TradingAccountPasswordUpdateFromSec)
{
	...
	{
		WriteLog(LogLevel::Info, "CThostFtdcTradingAccountPasswordUpdateFromSecField: BrokerID[%s], AccountID[%s], CurrencyID[%s], FromSec[%d]",
			TradingAccountPasswordUpdateFromSec->BrokerID, TradingAccountPasswordUpdateFromSec->AccountID, TradingAccountPasswordUpdateFromSec->CurrencyID, TradingAccountPasswordUpdateFromSec->FromSec);
	}
}
