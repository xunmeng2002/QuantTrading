...
void InnerMdSpiImpl::AddSubscribeInstrument(SubscribeInstrument* subscribeInstrument)
{
    m_SubscribeInstruments.push_back(subscribeInstrument);
}
...
void InnerMdSpiImpl::OnRspMdUserLogin(RspMdUserLoginField* rspMdUserLogin, RspInfoField* rspInfo, int requestID, bool isLast)
{
    ...
    for (auto subscribeInstrument : m_SubscribeInstruments)
    {
        Utility::Strcpy(m_ReqSubMarketData.ExchangeID, subscribeInstrument->ExchangeID.c_str());
        Utility::Strcpy(m_ReqSubMarketData.InstrumentID, subscribeInstrument->InstrumentID.c_str());
        ReqSubMarketData(&m_ReqSubMarketData);
    }
}
