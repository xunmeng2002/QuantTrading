...
CREATE TABLE IF NOT EXISTS `t_Product` (
  ...
  `MaxMarketOrderVolume` bigint COMMENT '市价单最大下单量',
  `MinMarketOrderVolume` bigint COMMENT '市价单最小下单量',
  `MaxLimitOrderVolume` bigint COMMENT '限价单最大下单量',
  `MinLimitOrderVolume` bigint COMMENT '限价单最小下单量',
...
CREATE TABLE IF NOT EXISTS `t_Position` (
  ...
  `TotalPosition` bigint COMMENT '总持仓数量',
  `TodayPosition` bigint COMMENT '今仓',
  `FrozenPosition` bigint COMMENT '冻结持仓',
...
CREATE TABLE IF NOT EXISTS `t_Order` (
  ...
  `VolumeRemain` bigint COMMENT '剩余数量',
