...
CREATE TABLE IF NOT EXISTS t_Product (
  ...
  MaxMarketOrderVolume bigint,  -- '市价单最大下单量'
  MinMarketOrderVolume bigint,  -- '市价单最小下单量'
  MaxLimitOrderVolume bigint,  -- '限价单最大下单量'
  MinLimitOrderVolume bigint,  -- '限价单最小下单量'
...
CREATE TABLE IF NOT EXISTS t_Position (
  ...
  TotalPosition bigint,  -- '总持仓数量'
  TodayPosition bigint,  -- '今仓'
  FrozenPosition bigint,  -- '冻结持仓'
